 ...
 */
export class UserAccess implements TUserAccess {
  ...
  /**
   * IDs of all available accesses in METIS.
   */
  public static get AVAILABLE_ACCESSES_IDS() {
    return [
      'default',
      'student',
      'instructor',
  ...
  /**
   * The names of all available accesses in METIS.
   */
  public static get AVAILABLE_ACCESSES_NAMES() {
    return [
      'Select an access level',
      'student',
      'instructor',
  ...
  public static isValidAccessId(accessId: TUserAccessId): boolean {
    return (
      UserAccess.AVAILABLE_ACCESSES_IDS.includes(accessId) &&
...
/**
 * Valid IDs for available user accesses.
 */
export type TUserAccessId = (typeof UserAccess.AVAILABLE_ACCESSES_IDS)[number]

/**
 * Valid names for available user accesses.
 */
export type TUserAccessName =
  (typeof UserAccess.AVAILABLE_ACCESSES_NAMES)[number]

/**
 * Type used for the abstract UserAccesses class.
 */
